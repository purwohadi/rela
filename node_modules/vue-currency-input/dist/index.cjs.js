...
})(exports.ValueScaling || (exports.ValueScaling = {}));
...
class CurrencyFormat {
    constructor(options) {
        ...
        this.options = {
            ...
            currencyDisplay: currencyDisplay !== exports.CurrencyDisplay.hidden ? currencyDisplay : undefined
        };
...
class CurrencyInput {
    ...
    init(options) {
        ...
        const valueScalingOptions = {
            [exports.ValueScaling.precision]: this.currencyFormat.maximumFractionDigits,
            [exports.ValueScaling.thousands]: 3,
            [exports.ValueScaling.millions]: 6,
            [exports.ValueScaling.billions]: 9
        };
        ...
        this.valueScalingFractionDigits =
            this.valueScaling !== undefined && this.options.valueScaling !== exports.ValueScaling.precision
    ...
    getCaretPositionOnFocus(value, selectionStart) {
        ...
        if (this.options.hideCurrencySymbolOnFocus || this.options.currencyDisplay === exports.CurrencyDisplay.hidden) {
            if (isNegative) {
                if (selectionStart <= 1) {
                    return 1;
                }
        ...
        if (this.options.hideCurrencySymbolOnFocus &&
            this.options.currencyDisplay !== exports.CurrencyDisplay.hidden &&
