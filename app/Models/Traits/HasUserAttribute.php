...
trait HasUserAttribute
{
  ...
  /**
   * Flagging user as admin skpd
   *
   * @return boolean
   */
  public function getIsAdminSkpdAttribute()
  {
    if ($skpd = $this->skpd()->first()) {
      return $skpd->e_is_induk == 1;
    }
  ...
  /**
   * Flagging user as admin ukpd
   *
   * @return boolean
   */
  public function getIsAdminUkpdAttribute()
  {
    if ($skpd = $this->skpd()->first()) {
      return $skpd->e_is_induk != 1;
    }
