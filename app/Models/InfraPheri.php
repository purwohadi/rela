...
class InfraPheri extends Model
{
	use HasHashSlug;
	...
	public function __construct(array $attributes = [])
	{
		...
		$this->setTable(config('tables.master.infra_pheri'));
	}

	public function getOpdAttribute()
  	{
		$metadata= new MetadataTerkait;
		return $metadata->where('opd_id', $this->opd_id)
					    ->get();
	}

	public function parent() {
		return $this->belongsTo(MetadataTerkait::class , 'infra_id');
	}
