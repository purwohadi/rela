...
class DomainEdukasiKeamananController extends Controller
{
    	/**
	 * DomainEdukasiKeamananController constructor.
	 *
	...
	public function dataEdukasiKeamanan(Request $request)
	{
        ...
        //return 'ini controller edukasi keamanan';
	}
	...
	{
		return $this->domainEdukasiKeamananRepositoryInterface->searchDomainEdukasiKeamanan($request);
		//dd($request->all());
	}

	public function getMetadata(Request $request)
	{
		return $this->domainEdukasiKeamananRepositoryInterface->getMetadata($request);
	}
}
